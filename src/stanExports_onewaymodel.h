...
namespace model_onewaymodel_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_onewaymodel");
    reader.add_event(23, 21, "end", "model_onewaymodel");
    return reader;
}
#include <stan_meta_header.hpp>
class model_onewaymodel
  : public stan::model::model_base_crtp<model_onewaymodel> {
private:
        int N;
        int J;
        ...
        vector_d response;
public:
    model_onewaymodel(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_onewaymodel_namespace::model_onewaymodel";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_onewaymodel_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_onewaymodel_namespace::model_onewaymodel stan_model;
#ifndef USING_R
